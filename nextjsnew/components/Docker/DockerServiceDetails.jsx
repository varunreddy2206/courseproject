...
export default function DockerServiceDetails() {
  const [openIndex, setOpenIndex] = useState(null);

  const topics = [
    { num: "01", title: "Introduction to DevOps & CI/CD", desc: "DevOps principles, pipelines, automation lifecycle." },
    { num: "02", title: "Version Control (Git & GitHub)", desc: "Branching, merging, repositories, GitHub workflows." },
    { num: "03", title: "Docker Essentials", desc: "Containers, images, Dockerfiles, registries, and networking." },
    { num: "04", title: "Kubernetes Fundamentals", desc: "Pods, deployments, services, namespaces, and Helm charts." },
    { num: "05", title: "Jenkins for CI/CD", desc: "Pipeline setup, build automation, integrations with Git." },
    { num: "06", title: "GitHub Actions & GitLab CI/CD", desc: "Workflow automation, runners, and deployment triggers." },
    { num: "07", title: "Infrastructure as Code (IaC) Basics", desc: "Intro to Terraform & Ansible for infrastructure automation." },
    { num: "08", title: "Cloud Deployment", desc: "Deploying containers on AWS, Azure, and Google Cloud." },
    { num: "09", title: "Monitoring & Logging", desc: "Prometheus, Grafana, and log visualization." },
    { num: "10", title: "Internship Project", desc: "Real-time CI/CD automation and Kubernetes deployment project." }
  ];
        ...
        <div className="lg:col-span-2 space-y-12">
          ...
          <div>
            <p className="text-gray-300 mb-4 leading-relaxed text-sm sm:text-base">
              Nuhvin Global Services Pvt. Ltd. offers a specialized Docker, Kubernetes & CI/CD Tools training program, built for aspiring DevOps engineers, cloud professionals, and developers who want to master containerization, orchestration, and continuous integration/deployment (CI/CD).
              This course provides a hands-on, project-driven experience on industry-leading tools — Docker, Kubernetes, Jenkins, GitHub Actions, and GitLab CI/CD — to help you automate, deploy, and scale modern applications.
              Limited to only 100 candidates per year, Nuhvin ensures focused mentorship, personalized feedback, and real-world project exposure. Upon completion, you’ll receive both a Course Completion Certificate and an Internship Training Certificate, making you job-ready for top DevOps and cloud roles.
          ...
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold mb-6">
              Why Choose Nuhvin for Docker, Kubernetes & CI/CD Tools Training?
            </h2>
            <ul className="space-y-4 text-sm sm:text-base">
              {[
                "Comprehensive Curriculum: Learn end-to-end CI/CD automation using industry-standard tools.",
                "Hands-On Learning: Build, run, and manage containerized applications.",
                "Expert Trainers: Learn from certified DevOps professionals and cloud engineers.",
                "Certification: Receive both Course Completion and Internship Training Certificates from Nuhvin Global Services Pvt. Ltd.",
                "Real-Time Projects: Work on real-time DevOps and CI/CD deployment projects.",
