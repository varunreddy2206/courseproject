...
export default function PythonServiceDetails() {
  ...
  const topics = [
    { num: "01", title: "Python Basics", desc: "Syntax, variables, operators, control structures, and functions." },
    { num: "02", title: "Data Structures", desc: "Lists, tuples, dictionaries, and sets." },
    { num: "03", title: "File Handling", desc: "Read/write operations, CSV, and text automation." },
    { num: "04", title: "Modules & Libraries", desc: "os, sys, re, datetime, requests, pandas, openpyxl." },
    { num: "05", title: "Object-Oriented Programming (OOPs)", desc: "Classes, objects, inheritance, and encapsulation." },
    { num: "06", title: "Automation with Python", desc: "Automating emails, Excel, browsers, and APIs." },
    { num: "07", title: "Web Scraping & APIs", desc: "Using BeautifulSoup, Selenium, and REST APIs." },
    { num: "08", title: "Basic Web Development", desc: "Flask/Django introduction and API development." },
    { num: "09", title: "Project Work", desc: "Develop an automation project (data scraping, reporting, or workflow tool)." },
    { num: "10", title: "Career Preparation", desc: "Resume building, LinkedIn optimization, interview practice." },
        ...
        <div className="lg:col-span-2 space-y-12">
          ...
          >
            <p className="text-gray-300 mb-4 leading-relaxed text-sm sm:text-base">
              The Python for Development & Automation course by Nuhvin Global Services Pvt. Ltd. is designed to turn absolute beginners into confident Python developers and automation specialists.
              You’ll master core Python programming, automation scripting, APIs, and basic web development, guided by experienced mentors.
              Through real-time projects and step-by-step practice, trainees learn to build software tools, automate repetitive tasks, and integrate APIs — skills in high demand across tech industries.
              With limited seats per batch, Nuhvin ensures personalized guidance, hands-on experience, and complete job readiness.
          ...
          >
            <h2 className="text-xl sm:text-2xl font-bold mb-6">
              Why Choose Nuhvin for Python Training?
            </h2>
            <ul className="space-y-4 text-sm sm:text-base">
              {[
                "Hands-On Learning: Real-time projects on Python automation and software development.",
                "Beginner to Advanced Curriculum: Covers Python basics to advanced scripting and frameworks.",
                "Automation Focus: Learn to automate web tasks, data entry, file handling, and reports.",
                "Expert Trainers: Guided by experienced developers and automation engineers.",
                "Internship Opportunity: Option to work on live projects with Nuhvin’s development team.",
                "Certification: Industry-recognized certificate from Nuhvin Global Services Pvt. Ltd.",
                "Placement Assistance: Resume building, mock interviews, and job referrals.",
                "Flexible Learning Modes: Online / Offline / Hybrid classes with weekend options.",
