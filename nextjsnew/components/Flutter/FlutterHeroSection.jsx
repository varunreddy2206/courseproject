...
export default function FlutterHeroSection() {
  return (
    <div
      className="relative w-full h-[440px] sm:h-[500px] md:h-[600px] lg:h-[640px] bg-cover bg-center"
      style={{ backgroundImage: "url('/flutter.jpg')" }} // Update path if needed
    >
      <div className="absolute inset-0 bg-black/50 flex flex-col justify-center items-center px-4 sm:px-6 lg:px-12">
        ...
        <p className="text-white text-base sm:text-lg md:text-xl text-center max-w-3xl mt-4">
          Build beautiful, high-performance mobile apps with Flutter at Nuhvin Academy. Learn Dart programming, state management, Firebase integration, and how to develop cross-platform Android and iOS apps from a single codebase.
        </p>
      </div>
    </div>
  );
