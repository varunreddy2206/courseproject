...
export default function AimlCareerOpportunities() {
  const roles = [
    "AI Engineer",
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <ul className="space-y-3 text-gray-300 text-sm sm:text-base">
            {roles.map((role, i) => (
              <li
                key={i}
                className="flex items-start gap-3 transform transition duration-300 hover:translate-x-2 hover:text-lime-400 cursor-pointer animate-fadeInUp"
                style={{
