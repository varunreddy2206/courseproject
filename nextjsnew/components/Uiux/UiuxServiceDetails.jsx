...
export default function UiuxServiceDetails() {
  const [openIndex, setOpenIndex] = useState(null);

  const topics = [
    { num: "01", title: "Introduction to UI/UX Design", desc: "UX principles, UI design basics, design thinking, usability concepts." },
    { num: "02", title: "Figma Fundamentals", desc: "Interface navigation, shapes, frames, components, prototyping." },
    { num: "03", title: "Adobe XD Fundamentals", desc: "Designing artboards, symbols, interactive prototypes, auto-animations." },
    { num: "04", title: "Wireframing & Mockups", desc: "Low-fidelity and high-fidelity designs, sketching, layout planning." },
    { num: "05", title: "Visual Design Principles", desc: "Typography, color theory, spacing, consistency, accessibility." },
    { num: "06", title: "Interaction Design", desc: "User flows, micro-interactions, transitions, and animations." },
    { num: "07", title: "UX Research & Testing", desc: "User personas, user testing, feedback analysis, iterative design." },
    { num: "08", title: "Portfolio & Real-Time Project", desc: "Build a complete UI/UX project for portfolio showcase." },
    { num: "09", title: "Internship & Certification", desc: "Hands-on internship experience with live project evaluation." }
  ];
        ...
        <div className="lg:col-span-2 space-y-12">
          ...
          <div>
            <p className="text-gray-300 mb-4 leading-relaxed text-sm sm:text-base">
              Nuhvin Global Services Pvt. Ltd. presents a comprehensive UI/UX Design Fundamentals program, crafted for beginners and aspiring designers who want to master user interface and user experience design using Figma and Adobe XD.
              This program covers the entire design workflow — from wireframing and prototyping to usability testing and UI visual design. You’ll work on real-world projects, learning how to design intuitive, visually appealing, and user-friendly digital experiences.
              With only 100 students per year, Nuhvin ensures personalized guidance, live project experience, and career-focused training. Graduates receive both a Course Completion Certificate and an Internship Training Certificate, recognized by startups and IT firms
          ...
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold mb-6">
              Why Choose Nuhvin for UI?UX Training?
            </h2>
            <ul className="space-y-4 text-sm sm:text-base">
              {[
                "Comprehensive Curriculum: Covers UX research, wireframes, prototypes, visual design, and design thinking.",
                "Hands-On Learning: Real-time projects using Figma and Adobe XD.",
                "Expert Trainers: Learn from experienced UI/UX designers and industry professionals.",
                "Certification: Receive both Course Completion and Internship Training Certificates from Nuhvin Global Services Pvt. Ltd.",
                "Real-Time Projects: Work on live projects using Figma and Adobe XD.",
