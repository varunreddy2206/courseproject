...
export default function AiHeroSection() {
  ...
  // Auto-scroll single image (right to left)
  useEffect(() => {
  ...
  return (
    <section className="bg-gradient-to-b from-[#000617] to-[#011c4f] text-white py-16 px-4 sm:px-8 md:px-12 lg:px-20 relative overflow-hidden">
        ...
        >
          ...
          <form className="space-y-5 sm:space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-start sm:items-center gap-2">
              ...
              />
              <label htmlFor="terms" className="text-white font-medium flex flex-wrap items-center gap-1 text-sm sm:text-base">
      ...
      {/* ✅ Show Thanks Card */}
      {showThanks && <ThanksCard onClose={() => setShowThanks(false)} />}
    </section>
  );
}
