...
export default function ApitestingServiceDetails() {
  const [openIndex, setOpenIndex] = useState(null);

  const topics = [
    { num: "01", title: "Introduction to Software Testing", desc: "Manual vs. Automation testing, SDLC, STLC, testing principles." },
    { num: "02", title: "Core Java for Selenium", desc: "OOP concepts, exception handling, collections, and Selenium Java integration." },
    { num: "03", title: "Selenium WebDriver", desc: "Locators, web elements, waits, actions, and automation scripts." },
    { num: "04", title: "TestNG & Maven", desc: "Test structure, annotations, data-driven testing, build automation." },
    { num: "05", title: "Page Object Model (POM)", desc: "Framework design patterns and reusable scripts." },
    { num: "06", title: "API Testing Fundamentals", desc: "REST API concepts, HTTP methods, status codes." },
    { num: "07", title: "Postman & REST Assured", desc: "Manual and automated API testing using JSON/XML payloads." },
    { num: "08", title: "CI/CD Integration", desc: "Jenkins, GitHub Actions, and test automation pipeline setup." },
    { num: "09", title: "Real-Time Projects", desc: "Web and API automation for enterprise-level applications." },
    { num: "10", title: "Internship & Certification", desc: "Project submission, performance evaluation, and certification issuance." }
  ];
        ...
        <div className="lg:col-span-2 space-y-12">
          ...
          <div>
            <p className="text-gray-300 mb-4 leading-relaxed text-sm sm:text-base">
              Nuhvin Global Services Pvt. Ltd. presents an industry-oriented Selenium & API Testing (Advanced QA) training program designed for aspiring automation testers, quality assurance engineers, and software professionals.
              This course helps you master automation testing using Selenium WebDriver, TestNG, Maven, Postman, and REST Assured with hands-on projects. You’ll learn to automate web and API test cases, integrate CI/CD pipelines, and work on real-world testing scenarios that reflect modern enterprise standards.
              Limited to 100 candidates per year, this program ensures personalized mentoring, practical exposure, and career-ready certification. You’ll receive both a Course Completion Certificate and an Internship Training Certificate, recognized by top IT and QA companies.
          ...
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold mb-6">
              Why Choose Nuhvin for Selenium & API Testing (Advanced QA)?
            </h2>
            <ul className="space-y-4 text-sm sm:text-base">
              {[
                "Comprehensive Curriculum: Covers Selenium WebDriver, API Testing, and Test Automation Frameworks.",
                "Hands-On Learning: Real-time web automation and API test case implementation.",
                "Expert Trainers: Learn from certified QA engineers and Automation professionals.",
                "Certification: Receive both Course Completion and Internship Training Certificates from Nuhvin Global Services Pvt. Ltd.",
                "Real-Time Projects: Gain experience working on live software testing projects.",
