...
export default function ReactCertification() {
  return (
    <section className="py-12 px-4 sm:px-6 lg:px-20 bg-gradient-to-b from-[#000617] to-[#011c4f] text-white">
      <div className="max-w-4xl mx-auto text-center space-y-6">
        ...
        <p className="text-gray-300 text-sm sm:text-base leading-relaxed animate-fadeInUp">
          After successful completion, you’ll receive an <span className="font-bold">React Native  App  Development Certification </span> from <span className="font-bold">Nuhvin Global Services Pvt. Ltd.</span> — recognized by startups and IT organizations for career opportunities.
        </p>
        <button
