...
export default function FrontendHeroSection() {
  return (
    <div
      ...
      style={{ backgroundImage: "url('/frontend.jpg')" }} // Update path if needed
    >
      <div className="absolute inset-0 bg-black/50 flex flex-col justify-center items-center px-4 sm:px-6 lg:px-12">
        ...
        <p className="text-white text-base sm:text-lg md:text-xl text-center max-w-3xl mt-4">
          Master the art of Frontend Development with Nuhvin Academy. Learn to build responsive, user-friendly websites using HTML, CSS, and JavaScript, and create powerful, interactive interfaces with React for modern web applications.
        </p>
      </div>
    </div>
  );
