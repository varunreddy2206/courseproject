...
export default function TestingHeroSection() {
  return (
    <div
      ...
      style={{ backgroundImage: "url('/testing.jpg')" }} // Update image path if needed
    >
      <div className="absolute inset-0 bg-black/50 flex flex-col justify-center items-center px-4 sm:px-6 lg:px-12">
        ...
        <p className="text-white text-base sm:text-lg md:text-xl text-center max-w-3xl mt-4">
          Learn software testing from the ground up with Nuhvin Academy. Master manual testing concepts, SDLC & STLC, and hands-on automation using Selenium, TestNG, JUnit, and real-world test frameworks.
        </p>
      </div>
    </div>
  );
