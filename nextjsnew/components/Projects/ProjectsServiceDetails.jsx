...
export default function ProjectsServiceDetails() {
    const [openIndex, setOpenIndex] = useState(null);

    const topics = [
        { num: "01", title: "Introduction to Real-Time Projects", desc: "Understanding project types: Web, Mobile App, AI/ML, project workflow." },
        { num: "02", title: "Web Development Projects", desc: "Frontend & Backend integration, full-stack frameworks, databases." },
        { num: "03", title: "Mobile App Projects", desc: "Flutter, React Native, Android (Kotlin), iOS (Swift) app development." },
        { num: "04", title: "AI/ML Projects", desc: "Data preprocessing, model building, deployment, AI-powered solutions." },
        { num: "05", title: "Version Control & Collaboration", desc: "Git, GitHub, team collaboration, code reviews." },
        { num: "06", title: "Agile & Project Management", desc: "Sprint planning, task tracking, project documentation." },
        { num: "07", title: "Testing & Deployment", desc: "Web & App testing, CI/CD pipelines, cloud deployment." },
        { num: "08", title: "Real-Time Problem Solving", desc: "Debugging, optimization, scaling, performance tuning." },
        { num: "09", title: "Portfolio & Showcase", desc: "Project presentations, demo apps, AI solution demos." },
        { num: "10", title: "Certification", desc: "Submission evaluation, performance feedback, certificate issuance." }
                ...
                <div className="lg:col-span-2 space-y-12">
                    ...
                    <div>
                        <p className="text-gray-300 mb-4 leading-relaxed text-sm sm:text-base">
                            Nuhvin Global Services Pvt. Ltd. presents a comprehensive Real-Time Project Internship program, designed to give students hands-on experience with live projects across Web Development, Mobile App Development, and Artificial Intelligence.
                            This program focuses on practical exposure, mentoring students through the entire project lifecycle, from planning and design to deployment and optimization. Students gain industry-relevant skills, teamwork experience, and problem-solving expertise.
                            Limited to only 100 candidates per year, this internship ensures personalized guidance, live project exposure, and career-focused training. On completion, participants receive both a Course Completion Certificate and an Internship Training Certificate, recognized by startups and IT companies.
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm sm:text-base">
                            {[
                                "Comprehensive Curriculum: Requirement analysis, design, development, testing, deployment.",
                                "Hands-On Learning: Learn on live web, mobile, and AI projects.",
                                "Expert Trainers: Learn from industry professionals and project managers.",
                                "Certification: Receive both Course Completion and Internship Training Certificates from Nuhvin Global Services Pvt. Ltd.",
                                "Real-Time Projects: Work on live web, mobile, and AI projects.",
